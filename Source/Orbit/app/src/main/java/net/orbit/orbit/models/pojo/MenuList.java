...
public class MenuList
{
    ...
    public static final List<MainMenuItem> teacherMenuList = Arrays.asList(
            new MainMenuItem(R.string.menu_add_student,R.string.menu_add_student, R.drawable.menu_student),
            new MainMenuItem(R.string.menu_enroll_student_in_course, R.string.menu_enroll_student_in_course, R.drawable.menu_enroll_student_in_course),
            new MainMenuItem(R.string.choose_course,R.string.choose_course, R.drawable.menu_link_parent_student),
            new MainMenuItem(R.string.view_course,R.string.view_course, R.drawable.menu_link_parent_student),
            new MainMenuItem(R.string.view_assignments,R.string.view_assignments, R.drawable.menu_link_parent_student),
            new MainMenuItem(R.string.create_assignment,R.string.create_assignment, R.drawable.menu_link_parent_student),
            new MainMenuItem(R.string.menu_logout, R.string.menu_logout, R.drawable.menu_logout));
