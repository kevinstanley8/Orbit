...
public class MemberInfoActivity extends AppCompatActivity{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar_member_info);
        ...
        mTextViewNickname = (TextView) findViewById(R.id.text_view_nickname);

        mRelativeLayoutBlockedByMe = (RelativeLayout) findViewById(R.id.relative_layout_blocked_by_me);
        ...
        mSwitchBlockedByMe = (SwitchCompat) findViewById(R.id.switch_blocked_by_me);
